...
const RevisionBank = () => {
  ...
  const [input, setInput] = useState("");
    ...
    async function run7(exam, sub, topic) {
        const papergene = `
You are an expert mentor for Indian banking competitive exams (such as IBPS PO, SBI Clerk, RBI Assistant, etc.).
...
- Ensure the content is accurate, up-to-date, and suitable for last-minute revision for high performance in the banking exam.
...
`;
  ...
  return (
    <Container>
      <Title>Banking Revision Planner</Title>

...
Generate a high-quality, railway entrance exam paper for the "${exam}" in the subject of "${sub}".
The paper must:
- Begin with a clear heading that displays the exam and subject names.
- List exactly ${num} unique and relevant questions that test a range of concepts and difficulty levels appropriate for this subject, as per the latest railway exam syllabus and pattern.
- Mix conceptual, application-based, and tricky questions to reflect real railway exam standards.
...
Ensure the questions are suitable for a student preparing for the "${exam}" and match the latest railway exam trends and difficulty.
...
`;
  ...
  const handleDownloadPDF = () => {
    ...
    pdf.setFontSize(16);
    pdf.text(
      `Railway - ${exam.toUpperCase()} - ${subject.toUpperCase()} (${numQuestions} Questions)`,
      margin,
      y
    );
    y += 30;
    ...
    pdf.save(`railway_${exam}_${subject}_paper.pdf`);
  };

  return (
    <Container>
      <Title>Railway Paper Generator</Title>

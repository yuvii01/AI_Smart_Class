...
const QuizJEE = () => {
  ...
  const [numQuestions, setNumQuestions] = useState(5);
    const [input, setInput] = useState("");
          ...
          "Generate a well-structured, in-syllabus SSC - level multiple-choice quiz for the ${exam} in the subject of ${sub}${topic ? `, specifically focusing on the topic : **${topic}**` : ''}.

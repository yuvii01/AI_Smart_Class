...
import DoubtsJEE from './DoubtsNda';
import PaperJEE from './PaperNda';
import QuizJEE from './QuizNda';
import RevisionJEE from './RevisionNda';
  ...
  return (
    <Container>
      <Title>{examType ? `${examType} - ` : ''}
        NDA - What would you like to do?</Title>
      <BoxGrid>

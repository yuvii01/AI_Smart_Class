...
import PaperUPSC from './PaperUPSC';
import DoubtsUPSC from './DoubtsUPSC';
import RevisionUPSC from './RevisionUPSC';
    ...
    <Container>
      ...
      {showDoubts && (
        <Popup>
          ...
          <DoubtsUPSC examType = {examType}/>
        </Popup>
      )}
      {showPaper && (
        <Popup>
          <CloseBtn onClick={() => setShowPaper(false)}>✖</CloseBtn>
          <PaperUPSC examType = {examType} />
        </Popup>
      )}
      {showQuiz && (
        <Popup>
      ...
      {showPlanner && (
        <Popup>
          ...
          <RevisionUPSC examType = {examType} />
        </Popup>
      )}
    </Container>
  );

...
import DoubtsNEET from './DoubtsNEET';
import QuizNEET from './QuizNEET';
import RevisionNEET from './RevisionNEET';
import PaperNEET from './PaperNEET';
    ...
    <Container>
      ...
      {showPlanner && (
        <Popup>
          ...
          <RevisionNEET examType = {examType} />
        </Popup>
      )}
    </Container>
  );
